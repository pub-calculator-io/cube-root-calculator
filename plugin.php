...
if (!function_exists('add_shortcode')) return "No direct call for Cube Root Calculator by Calculator.iO";

function display_ci_cube_root_calculator(){
    $page = 'index.html';
    return '<h2><a href="https://www.calculator.io/cube-root-calculator/" target="_blank"><img src="' . esc_url(plugins_url('assets/images/icon-48.png', __FILE__ )) . '" width="48" height="48"></a> Cube Root Calculator</h2><div><iframe style="background:transparent; overflow: scroll" src="' . esc_url(plugins_url($page, __FILE__ )) . '" width="100%" frameBorder="0" allowtransparency="true" onload="this.style.height = this.contentWindow.document.documentElement.scrollHeight + \'px\';" id="ci_cube_root_calculator_iframe"></iframe></div>';
}

add_shortcode( 'ci_cube_root_calculator', 'display_ci_cube_root_calculator' );